...
# Embedded visual assets – self-contained deployment (cover and structure resized to 80% and WebP-compressed)
...
def show_login():
    ...
    with cover_middle:
        st.markdown(
            embedded_image_html(COVER_IMAGE_B64, mime="image/webp", max_width=867, alt="Alpha Portfolio Builder"),
            unsafe_allow_html=True,
        )
...
if step == 0:
    ...
    with image_middle:
        st.markdown(
            embedded_image_html(STRUCTURE_IMAGE_B64, mime="image/webp", max_width=1229, alt="Structure layers"),
            unsafe_allow_html=True,
        )
