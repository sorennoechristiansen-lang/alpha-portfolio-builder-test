...
# 2026-08-31
# Revision C: APB cover/login branding, header logo on all wizard pages, and Structure layers illustration added to Step 2.
#
# Vigtige ændringer:
...
def show_login():
    cover_left, cover_middle, cover_right = st.columns([1, 5, 1])
    with cover_middle:
        st.markdown(
...
if step == 0:
    ...
    image_left, image_middle, image_right = st.columns([1, 5, 1])
    with image_middle:
        st.markdown(
