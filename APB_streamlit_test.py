...
**Regions**  
Controls how strongly APB should follow the geographic distribution selected later. Increasing it makes regional balance more important; reducing it lets stock quality and the other priorities override geography more easily. Regional targets therefore work as portfolio-level preferences, not as isolated rules for each stock.
