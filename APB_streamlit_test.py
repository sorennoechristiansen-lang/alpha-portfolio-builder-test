...
st.info(
    "When you press BUILD PORTFOLIO, your Phase 1 settings will be sent securely "
    "to SIMGROVA for processing. The finished portfolio will later be returned "
    ...
    if st.button("BUILD PORTFOLIO", type="primary", use_container_width=True):
        try:
            ...
            payload = {
                ...
                "basic_rules": {
                    "portfolio_value_dkk": portfolio_value,
                    "minimum_position_dkk": min_position,
