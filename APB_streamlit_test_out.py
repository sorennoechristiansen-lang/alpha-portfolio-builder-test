...
DISCLAIMER = (
    ...
    "your own research and investment decisions. Alpha Portfolio Builder is under "
    "continuous development, and although we work to make the calculations and presentation "
    "as reliable as possible, errors, omissions or unexpected results may occur. Please review "
    "the portfolio and its underlying information carefully before making investment decisions."
)
...
# ------------------------------------------------------------
# COMMON DISCLAIMER / BOTTOM NAVIGATION
# ------------------------------------------------------------
st.markdown("---")
